...
```{r makeVegTables, include = FALSE, cache = FALSE}
...
```{r makeEcozoneTables, include = FALSE, cache = FALSE}
## ECOLOGICAL ZONATION -----------------------------
...
```{r addFires, include = FALSE, cache = FALSE}
## NO. FIRES ---------------------------------------
...
```{r addZeroesTables, include = FALSE, cache = FALSE}
...
```{r addEcozones, include = FALSE, cache = FALSE}
...
```{r addCameronVegTypes, include = FALSE, cache = FALSE}
...
```{r summaryTables, include = FALSE, cache = FALSE}
...
Mean absolute deviation of simulated no. cohorts with respect to average observed no. cohorts for a given stand typo
