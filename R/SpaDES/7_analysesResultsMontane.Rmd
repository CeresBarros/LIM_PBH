...
## add vegTypes and pixels with no fires to burn data - note that we loose the yearly fire data.
allPixelBurnData <- allPixelBurnData[unique(allPixelCohortDataMnt[, .(scenario, rep, year, pixelIndex, vegTypeCN)]), 
...
## drop pixelGroup
allPixelBurnData[, pixelGroup := NULL]
