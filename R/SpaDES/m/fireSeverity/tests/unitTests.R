...
test_dir("D:/Cherry/GitHub/LandscapesInMotion/R/SpaDES/m/fireSeverity/tests/testthat")

# Alternative, you can use test_file to test individual test file, e.g.:
test_file("D:/Cherry/GitHub/LandscapesInMotion/R/SpaDES/m/fireSeverity/tests/testthat/test-template.R")
