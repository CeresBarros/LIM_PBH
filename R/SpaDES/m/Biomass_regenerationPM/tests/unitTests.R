...
test_dir("E:/GitHub/LandscapesInMotion/R/SpaDES/m/LandR_BiomassRegenPM/tests/testthat")

# Alternative, you can use test_file to test individual test file, e.g.:
test_file("E:/GitHub/LandscapesInMotion/R/SpaDES/m/LandR_BiomassRegenPM/tests/testthat/test-template.R")
