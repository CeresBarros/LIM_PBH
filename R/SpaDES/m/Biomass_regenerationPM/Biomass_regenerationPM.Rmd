...
modules <- list("LandR_BiomassRegenPM")
objects <- list()
inputs <- list()
outputs <- list()
...
If `sourceURL` is specified, `downloadData("LandR_BiomassRegenPM", "path/to/modules/dir")` may be sufficient.
