...
test_dir("D:/Cherry/GitHub/LandscapesInMotion/R/SpaDES/m/simplifyLCCVeg/tests/testthat")

# Alternative, you can use test_file to test individual test file, e.g.:
test_file("D:/Cherry/GitHub/LandscapesInMotion/R/SpaDES/m/simplifyLCCVeg/tests/testthat/test-template.R")
